...
jquery__WEBPACK_IMPORTED_MODULE_2___default()(document).ready(function(){
	...
	jquery__WEBPACK_IMPORTED_MODULE_2___default()('#myTab a').hover( function (e) {
		jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).tab('show');
	});
	jquery__WEBPACK_IMPORTED_MODULE_2___default()( ".men" ).mouseleave(function(){
		jquery__WEBPACK_IMPORTED_MODULE_2___default()(".menu-content").removeClass('active show');
		jquery__WEBPACK_IMPORTED_MODULE_2___default()('#myTab a').removeClass('active show');
	});
	
	jquery__WEBPACK_IMPORTED_MODULE_2___default()('.horizontal-gallery').lightGallery({
		selector: '.img-slide'
	});
});
