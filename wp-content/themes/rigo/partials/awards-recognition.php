<section class="awards-recognition  text-center px-2 d-none d-md-block">
  <p class="h7">Awards and Recognition</p>
  <div class="row-fluid  d-none d-sm-inline">
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-md-12 m-4">
          <span class="logo awards px-1 mx-3" id="king-of-year"></span>
          <span class="logo awards px-1 mx-3" id="global-peace"></span>
          <span class="logo awards px-1 mx-3" id="wedding-wire"></span>
          <span class="logo awards px-1 mx-3" id="prodly-recognize"></span>
        </div>
      </div>
    </div>
  </div>
